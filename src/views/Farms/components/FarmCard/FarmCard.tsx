...
import { Flex, Text, Skeleton } from 'yieldnyan-uikit'
...
const FarmCard: React.FC<FarmCardProps> = ({ farm, removed, cakePrice, bnbPrice, ethereum, account }) => {
  ...
  const farmImage = farm.pid.toString().toLocaleLowerCase()
  ...
  const totalValue: BigNumber = useMemo(() => {
    ...
    if (farm.quoteTokenSymbol === QuoteToken.NYAN) {
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : 'NYAN'
  ...
  return (
    <FCard>
      {farm.tokenSymbol === 'NYAN' && <StyledCardAccent />}
      <CardHeading
        lpLabel={lpLabel}
