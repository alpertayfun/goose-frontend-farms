  ...
  return (
    <>
      ...
      <Text as="p" mb="24px">
        {TranslateString(
          999,
          'You can change your profile pic later if you get another approved YieldNyan Collectible.',
        )}
      </Text>
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" mb="24px" color="textSubtle">
            {TranslateString(999, 'Cost: 4 NYAN')}
          </Text>
          {nfts.map((nft) => {
          ...
          {!hasMinimumCakeRequired && (
            <Text color="failure" mt="16px">
              {TranslateString(999, `A minimum of ${minimumCakeBalance} NYAN is required`)}
            </Text>
          )}
        </CardBody>
      </Card>
