...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from 'yieldnyan-uikit'
    ...
    return (
      <>
        ...
        <Text bold fontSize="20px" mb="24px">
          {TranslateString(999, 'We couldn’t find any YieldNyan Collectibles in your wallet.')}
        </Text>
        <Text as="p">
          {TranslateString(
            999,
            'You need a YieldNyan Collectible to finish setting up your profile. If you sold or transferred your starter collectible to another wallet, you’ll need to get it back or acquire a new one somehow. You can’t make a new starter with this wallet address.',
          )}
        </Text>
      </>
    )
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" color="textSubtle" mb="24px">
            {TranslateString(999, 'Only approved YieldNyan Collectibles can be used.')}
