...
import { Heading, Text, Flex, ChevronRightIcon } from 'yieldnyan-uikit'
  ...
  return (
    <>
      <Heading as="h4" size="md" mb="8px">
        {TranslateString(999, 'YieldNyan Collectibles')}
      </Heading>
      <Text as="p">
        {TranslateString(
          999,
          'YieldNyan Collectibles are special ERC-721 NFTs that can be used on the PancakeSwap platform.',
        )}
      </Text>
      <Text as="p">
        {TranslateString(
          999,
          "NFTs in this user's wallet that aren't approved YieldNyan Collectibles won't be shown here.",
        )}
      </Text>
      ...
      <Flex alignItems="center" justifyContent="flex-end">
        <Link to="/nft">{TranslateString(999, 'See all approved YieldNyan Collectibles')}</Link>
        <ChevronRightIcon />
      </Flex>
    </>
  )
